...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   ...
   <!--Formatação CSS interno da pagina home-->
...
<!--Formatação div links da pagina-->
    ...
    <div id="link1">
        <a href="#"><img src="img/imagem4.jpg" title="confira as oportunidades" alt="link" width="230" height="150" /></a>
    </div>

    
    <div id="link2">
        <a href="#"><img src="img/imagem2.jpg" title="confira as oportunidades" alt="link" width="230" height="150" /></a>
    </div>

    
    <div id="link4">
        <a href="#"><img src="img/imagem.jpg" title="confira as oportunidades" alt="link" width="230" height="150" /></a>
    </div>
